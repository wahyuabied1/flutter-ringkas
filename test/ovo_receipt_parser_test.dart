...
// aplikasi OVO) untuk merepresentasikan pola umum: judul aksi, nominal
// dengan "Rp", nama pihak lain, tanggal berbahasa Indonesia, dan label
// metadata. Belum diverifikasi terhadap screenshot OVO asli — kalau pola
// aslinya berbeda, sesuaikan kata kunci di ovo_receipt_parser.dart.
import 'package:flutter_test/flutter_test.dart';
import 'package:Ringkas/data/model/category_model.dart';
import 'package:Ringkas/data/services/ovo_receipt_parser.dart';

void main() {
  group('parseOvoReceipt', () {
    test('pengeluaran dengan tanda minus dan tanggal lengkap', () {
      const text = '''
OVO
Pembayaran Berhasil
- Rp 45.000
...
''';
    ...
    test('teks kosong tidak melempar error', () {
      final r = parseOvoReceipt('');
      expect(r.amount, isNull);
      expect(r.date, isNull);
      expect(r.note, 'Transaksi OVO');
    });
